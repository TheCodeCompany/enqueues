...
class Config {
	 ...
	 *
	 * @var \Enqueues\Base\Core\Application
	 */
	protected $app;
	 ...
	 *
	 * @param \Enqueues\Base\Core\Application $app Application instance this config is for.
	 *
	 * TODO pass name and directory so we could use this is in a theme or something.
	 */
	public function __construct( \Enqueues\Base\Core\Application $app ) {
